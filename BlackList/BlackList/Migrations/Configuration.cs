namespace BlackList.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BlackList.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(BlackList.Models.ApplicationDbContext context)
        {
            ...
            ListItem a2 = new ListItem { ListItemID = 2, ItemName = "A", ListID = second.ListID };
            ListItem a3 = new ListItem { ListItemID = 3, ItemName = "A", ListID = third.ListID };
            ListItem b1 = new ListItem { ListItemID = 4, ItemName = "B", ListID = first.ListID };
            ListItem c1 = new ListItem { ListItemID = 5, ItemName = "C", ListID = first.ListID };
            context.ListItems.AddOrUpdate(n => n.ItemName, a1, a2, a3, b1, c1);
            context.SaveChanges();


            ApplicationUser link = new ApplicationUser { Id = "1", UserName = "Linkan" };
            ApplicationUser stening = new ApplicationUser { Id = "2", UserName = "Stening"};
            ApplicationUser alex = new ApplicationUser { Id = "3", UserName = "Alex"};
